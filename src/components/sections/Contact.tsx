      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4">
              {contactInfo.map((item) => (
                <a
                  ...
                  className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-[var(--card)] border border-[var(--border)] hover:border-[var(--primary)]/50 transition-colors group"
                >
                  <div className="p-2 sm:p-3 rounded-xl bg-gradient-to-br from-[var(--gradient-start)]/20 to-[var(--gradient-end)]/20 group-hover:from-[var(--gradient-start)]/30 group-hover:to-[var(--gradient-end)]/30 transition-colors shrink-0">
            ...
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-r from-[var(--gradient-start)]/10 to-[var(--gradient-end)]/10 border border-[var(--primary)]/20">
